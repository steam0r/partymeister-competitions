...
class CompetitionGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('switches', trans('partymeister-competitions::backend/competitions.status'))->renderer(BladeRenderer::class, ['template' => 'partymeister-competitions::grid.competition_status']);
