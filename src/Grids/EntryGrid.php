...
class EntryGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('name', trans('partymeister-competitions::backend/entries.name'))->renderer(BladeRenderer::class, ['template' => 'partymeister-competitions::grid.entry_name']);
        $this->addColumn('sort_position', trans('partymeister-competitions::backend/entries.sort_position_short'), true)->renderer(BladeRenderer::class, ['template' => 'partymeister-competitions::grid.input_callback', 'field' => 'sort_position']);
        $this->addColumn('last_file_upload', trans('partymeister-competitions::backend/entries.last_file_uploaded_at'))->renderer(DateRenderer::class);
        $this->addColumn('status', trans('partymeister-competitions::backend/entries.status'))->renderer(BladeRenderer::class, ['template' => 'partymeister-competitions::grid.entry_status']);
