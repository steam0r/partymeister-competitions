...
class VoteCategoryGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addColumn('has_negative', trans('partymeister-competitions::backend/vote_categories.has_negative'), true)->renderer(BooleanRenderer::class);
        $this->addColumn('has_comment', trans('partymeister-competitions::backend/vote_categories.has_comment'), true)->renderer(BooleanRenderer::class);
        $this->addColumn('has_special_vote', trans('partymeister-competitions::backend/vote_categories.has_special_vote'), true)->renderer(BooleanRenderer::class);
